  ...
  const renderConversionResult = () => {
    switch (conversionOutcome) {
      ...
      case 'fail':
        ...
        labelled differently between Spotify and SoundCloud. You could try searching for the track directly in the Spotify app.`;
        return <ErrorBar errorMessage={errorMessage} />;
    }
  };

  return <div className="conversionResult">{renderConversionResult()}</div>;
};
